...
function bindSlideToggle(trigger, boxBody, content, openClass){
    ...
    button.element.addEventListener('click', () => {
        if (button.active === false) {      //проверяем состояние меню на неактивность
            button.active = true;           //если неактивна - делаем активной
...
function start(){
    gapi.client.init({
        'apiKey': 'AIzaSyDk1zLCx-5T0yCxtfGSaSORTwx45mU3jos',
        'discoveryDocs': ["https://www.googleapis.com/discovery/v1/apis/youtube/v3/rest"]
    }).then(function() {
        return gapi.client.youtube.playlistItems.list({
            "part": "snippet,contentDetails",
            "maxResults": 9,
            "playlistId": "PL3LQJkGQtzc4gsrFkm4MjWhTXhopsMgpv"//"PLx0sYbCqOb8TBPRdmBHs5Iftvv9TPboYG"
        });
...
//AIzaSyDk1zLCx-5T0yCxtfGSaSORTwx45mU3jos
